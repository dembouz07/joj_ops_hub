...
export const mockSites: Site[] = [
  { id: 1, name: 'Stade Iba Mar Diop', type: 'stade', location: 'Dakar', capacity: 15000 },
  { id: 2, name: 'Tour de l\'Œuf', type: 'complexe', location: 'Dakar', capacity: 8000 },
  { id: 3, name: 'Corniche Ouest', type: 'espace', location: 'Dakar', capacity: 25000 },
  { id: 4, name: 'Dakar Arena', type: 'arène', location: 'Diamniadio', capacity: 15000 },
  { id: 5, name: 'Stade Abdoulaye Wade', type: 'stade', location: 'Diamniadio', capacity: 50000 },
  { id: 6, name: 'Centre des Expositions de Dakar', type: 'centre', location: 'Diamniadio', capacity: 12000 },
  { id: 7, name: 'Centre des Sports Équestres', type: 'centre', location: 'Diamniadio', capacity: 5000 },
  { id: 8, name: 'Plage de Saly Ouest', type: 'plage', location: 'Saly', capacity: 10000 },
];
...
export const mockIncidents: Incident[] = [
  ...
  {
    id: 4, title: 'Suspect photographiant la salle de contrôle', description: 'Personne non identifiée tentant de photographier l\'espace de contrôle des opérations.', status: 'open', severity: 'high', site_id: 4, created_by: 7, assigned_to: null, started_at: '2026-04-18T09:15:00Z', resolved_at: null, site: mockSites[3], creator: mockUsers[6], assignee: null, created_at: '2026-04-18T09:13:00Z',
  },
  {
  ...
  {
    id: 6, title: 'Vol de matériel technique', description: 'Disparition d\'équipements audiovisuels dans la salle de presse.', status: 'in_progress', severity: 'high', site_id: 6, created_by: 5, assigned_to: 2, started_at: '2026-04-18T07:30:00Z', resolved_at: null, site: mockSites[5], creator: mockUsers[4], assignee: mockUsers[1], created_at: '2026-04-18T07:28:00Z',
  },
];
...
export const mockTasks: Task[] = [
  ...
  { id: 2, title: 'Coordination transport VIP', description: 'Organiser le transport des délégations officielles depuis Diamniadio vers les sites de compétition.', category: 'transports', status: 'in_progress', priority: 'urgent', assigned_to: 3, site_id: 5, scheduled_time: '2026-04-19T15:00:00Z', completed_at: null, assignee: mockUsers[2], site: mockSites[4], created_at: '2026-04-18T09:00:00Z' },
  { id: 3, title: 'Test système anti-incendie', description: 'Vérification et test complet du système anti-incendie dans toutes les zones de la Dakar Arena.', category: 'securite', status: 'pending', priority: 'medium', assigned_to: 7, site_id: 4, scheduled_time: '2026-04-19T08:00:00Z', completed_at: null, assignee: mockUsers[6], site: mockSites[3], created_at: '2026-04-18T11:00:00Z' },
  { id: 4, title: 'Briefing équipe protocole', description: 'Réunion de briefing avec l\'équipe protocole pour la cérémonie d\'ouverture sur la Corniche Ouest.', category: 'protocole', status: 'completed', priority: 'high', assigned_to: 4, site_id: 3, scheduled_time: '2026-04-18T14:00:00Z', completed_at: '2026-04-18T15:30:00Z', assignee: mockUsers[3], site: mockSites[2], created_at: '2026-04-18T08:00:00Z' },
  { id: 5, title: 'Installation équipement médias', description: 'Installation et configuration des équipements de transmission pour les diffuseurs internationaux au Centre des Expositions.', category: 'medias', status: 'in_progress', priority: 'high', assigned_to: 5, site_id: 6, scheduled_time: '2026-04-18T10:00:00Z', completed_at: null, assignee: mockUsers[4], site: mockSites[5], created_at: '2026-04-17T16:00:00Z' },
  ...
  { id: 7, title: 'Maintenance portiques d\'accès', description: 'Réparation urgente des portiques de contrôle d\'accès au Tour de l\'Œuf.', category: 'securite', status: 'in_progress', priority: 'urgent', assigned_to: 6, site_id: 2, scheduled_time: '2026-04-18T14:00:00Z', completed_at: null, assignee: mockUsers[5], site: mockSites[1], created_at: '2026-04-18T14:05:00Z' },
  { id: 8, title: 'Préparation zone mixte', description: 'Aménagement et sécurisation de la zone mixte pour les interviews post-compétition à la plage de Saly Ouest.', category: 'medias', status: 'pending', priority: 'low', assigned_to: 8, site_id: 8, scheduled_time: '2026-04-19T12:00:00Z', completed_at: null, assignee: mockUsers[7], site: mockSites[7], created_at: '2026-04-18T10:30:00Z' },
  ...
  { id: 10, title: 'Inspection centre équestre', description: 'Inspection de sécurité et vérification des équipements du Centre des Sports Équestres avant les épreuves.', category: 'securite', status: 'pending', priority: 'high', assigned_to: 7, site_id: 7, scheduled_time: '2026-04-19T07:00:00Z', completed_at: null, assignee: mockUsers[6], site: mockSites[6], created_at: '2026-04-18T13:00:00Z' },
  { id: 11, title: 'Coordination navettes athlètes', description: 'Planification et coordination des navettes entre Diamniadio et les différents sites de compétition.', category: 'transports', status: 'in_progress', priority: 'high', assigned_to: 3, site_id: 5, scheduled_time: '2026-04-19T06:00:00Z', completed_at: null, assignee: mockUsers[2], site: mockSites[4], created_at: '2026-04-18T15:00:00Z' },
  { id: 12, title: 'Gestion demandes médias', description: 'Traitement des demandes d\'accréditation médias en attente et coordination avec les équipes de tournage.', category: 'medias', status: 'pending', priority: 'medium', assigned_to: 5, site_id: 6, scheduled_time: '2026-04-19T10:00:00Z', completed_at: null, assignee: mockUsers[4], site: mockSites[5], created_at: '2026-04-18T16:00:00Z' },
  { id: 13, title: 'Audit badges d\'accès VIP', description: 'Vérification et audit complet de tous les badges VIP émis pour la cérémonie d\'ouverture. Contrôle de sécurité et validation des autorisations.', category: 'accreditations', status: 'pending', priority: 'urgent', assigned_to: null, site_id: 3, scheduled_time: '2026-04-26T08:00:00Z', completed_at: null, assignee: null, site: mockSites[2], created_at: '2026-04-25T14:00:00Z' },
];
